...
class BertTokenizer(object):
    ...
    def __init__(self, vocab_file, do_lower_case=True, do_basic_tokenize=True,
        ...
        self.idx_to_token = collections.OrderedDict(
        ...
        if self.never_split:
            ...
            self.never_split_extended = set()
        #
        for item in self.all_special_tokens:
            self.never_split_extended.add(item)
        #
    ...
    def convert_ids_to_tokens(self, list_idx):
        """
        """
        return [self.idx_to_token.get(tid, self.unk_token) for tid in list_idx]
        #
    #
